    ...
    className:"grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-8 bg-white p-4 md:p-6 shadow-md border border-zinc-200/50 items-center",children:[
      u.jsxs("div",{
        className:"lg:col-span-7 flex flex-col justify-between space-y-2.5",children:[
          u.jsxs("div",{
            onClick:()=>a.images.length>0&&p(!0),className:ie("relative w-full h-[
              180px
            ] sm:h-[
              220px
            ] lg:h-[
              240px
            ] overflow-hidden border border-zinc-200 bg-zinc-200 shadow-inner group",a.images.length>0?"cursor-zoom-in":"cursor-default"),children:[
              a.images.length>0?u.jsxs("div",{
                className:"relative w-full h-full",children:[
                  u.jsx("img",{
                    src:errSrcs[
                      ...
                      d+1
                    }`,className:ie("w-full h-full object-cover object-center group-hover:scale-[
                      1.015
                    ] transition-all duration-750 select-none",loadingSrcs[
                      a.images[
                        d
                      ]
                    ...
                    className:"absolute inset-0 bg-zinc-100/90 backdrop-blur-sm flex items-center justify-center animate-pulse",children:u.jsx("p",{
                      className:"text-[
                        10px
                      ] text-zinc-500 font-bold tracking-widest uppercase",children:i==="ENG"?"Refining premium grain...":"Kraujas smalkas detaļas..."
                    })
                  }),errSrcs[
                    a.images[
                      d
                    ...
                    className:"absolute inset-0 bg-neutral-900 border border-brand-orange/30 flex flex-col items-center justify-center text-center p-4",children:[
                      u.jsx("p",{
                        ...
                        className:"text-[
                          9px
                        ] text-zinc-400 uppercase tracking-widest",children:i==="ENG"?"Visual assets loading securely":"Attēli tiek droši sagatavoti"
                      })
                    ]
                  })
                ]
                ...
                className:"w-full h-full flex flex-col items-center justify-center bg-zinc-100 text-zinc-400 select-none",children:u.jsx("span",{
                  className:"text-[
                    10px
                  ] uppercase tracking-widest font-extrabold text-zinc-400/80",children:i==="ENG"?"No images added yet":"Pagaidām nav pievienotu attēlu"
                })
                ...
                className:"absolute top-2.5 left-2.5 btn-wood-oak border-none text-white py-1 px-2.5 text-[
                  8.5px
                ] uppercase tracking-widest font-extrabold select-none shadow-md",children:i==="ENG"?a.isPlaceholder?`Portfolio ${
                  a.placeholderNum
                }`:((z=Ni[
                  a.category
                ])==null?void 0:z.EN)||a.category:a.isPlaceholder?`Portfolio ${
                  a.placeholderNum
                }`:((k=Ni[
                  a.category
                ])==null?void 0:k.LV)||a.category
              }),a.images.length>0&&u.jsxs("div",{
                className:"absolute bottom-2.5 right-2.5 bg-black/70 text-white py-1 px-2.5 text-[
                  10px
                ] tracking-widest font-extrabold select-none rounded-md shadow-sm border border-white/10",children:[
                  d+1,"/",a.images.length
                ]
              })
            ]
            ...
            className:"grid grid-cols-7 gap-1",children:a.images.slice(0,7).map((V,H)=>u.jsx("button",{
              type:"button",draggable:r,onDragStart:Y=>v(Y,H),onDragOver:x,onDrop:Y=>j(Y,H),onClick:()=>h(H),className:ie("aspect-[
                4/3
              ] w-full overflow-hidden border bg-zinc-100 transition-all duration-200 relative group cursor-pointer",d===H?"border-brand-orange ring-1 ring-brand-orange scale-102 opacity-100":"border-zinc-200 opacity-60 hover:opacity-100 shadow-sm",r?"cursor-grab active:cursor-grabbing border-zinc-300":""),"aria-label":i==="ENG"?`View image ${
                H+1
              }`:`Skatīt attēlu ${
                H+1
        ...
        className:"lg:col-span-5 flex flex-col justify-between py-2 lg:pl-4 space-y-6 lg:space-y-8",children:[
          u.jsxs("div",{
            ...
            className:"flex items-center space-x-2 text-[
              10px
            ] uppercase font-bold text-zinc-400 tracking-wider pt-4 border-t border-zinc-150",children:[
              u.jsx(Ad,{
          ...
          initial:{
            ...
            u.jsxs("div",{
              className:"flex justify-between items-center text-white text-xs tracking-wider border-b border-white/10 pb-4 h-12",children:[
                u.jsxs("div",{
                  className:"font-serif italic font-light truncate max-w-[
                    80%
                  ] uppercase",children:[
              ...
              className:"flex-1 flex items-center justify-center relative my-6",children:[
                u.jsx("img",{
                  src:a.images[
                    ...
                    i==="ENG"&&a.titleEN||a.title
                  } - Zoom`,className:"max-w-full max-h-[
                    75vh
                  ] object-contain shadow-2xl transition-transform duration-300",onClick:V=>V.stopPropagation(),referrerPolicy:"no-referrer"
                }),a.images.length>1&&u.jsxs(u.Fragment,{
                  children:[
                    u.jsx("button",{
                ...
                className:"max-w-xl mx-auto flex flex-col items-center space-y-4",children:[
                  u.jsxs("div",{
                    className:"text-white text-[
                      11px
                    ] tracking-widest uppercase font-extrabold opacity-75",children:[
                      d+1," / ",a.images.length
                    ]
                  }),u.jsx("div",{
